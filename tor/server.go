...
func Run(ctx context.Context) error {
	...
	// TODO: read key from session file
	...
	_ = os.WriteFile("debug_onion.key", privKeyBytes, 0644)

	// TODO: save private key to save the session

	// hexkey := myonion.KeyFromOnionPubKey(pubKeyBytes)
	// log.Warnf("connection key: %s\n", hexkey)
	// decode back and compare
	onionDecoded, err := myonion.PubKeyToOnionAddress(pubKeyBytes)
	if err != nil {
